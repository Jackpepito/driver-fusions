...
srun python src/analysis/predict_fusions_set_driver.py \
  --model-ckpt /work/H2020DeciderFicarra/gcapitani/driver-fusion/results/fuson/20260226_190047/probe_best.pt \
  --embedding-model fuson
